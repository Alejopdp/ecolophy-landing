  ...
  const processSteps = [
    {
      ...
      text:
        "Desde Play Store o App Store, y recibí los stickers QR directamente en tu domicilio",
    },
    {
      stepNumber: 2,
      ...
      text:
        "Separá tus residuos limpios y secos en una bolsa separada del resto. No te preocupes, te indicaremos la forma correcta de hacerlo",
    },
    {
      stepNumber: 3,
      ...
      text:
        "Una vez llenada la bolsa, pegá el sticker QR a la bolsa para comenzar la etapa de solicitud",
    },
    {
      stepNumber: 4,
      imgSrcDesktop: props.solicitudRetiroDesktopImg,
      imgSrcMobile: props.solicitudRetiroMobileImg,
      title: "SOLICITÁ TU RETIRO",
      text:
        "Luego de escanear el código QR, solicitá el retiro de tu bolsa y nosotros la pasaremos a buscar en el día",
    },
    {
      stepNumber: 5,
      ...
      text:
        "Una vez entregada la bolsa, recibirás Ecopoints para intercambiarlos por beneficios exlusivos",
    },
  ]
